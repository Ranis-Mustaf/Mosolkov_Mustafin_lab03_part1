...
dataset_path = r"C:/Users/musta/OneDrive/Рабочий стол/lab3_part1/dataset"

def train_model():
    model = YOLO(r'C:/Users/musta/OneDrive/Рабочий стол/lab3_part1/runs/detect/train9/weights/best.pt')
...
def run_model(image_path):
    session = ort.InferenceSession(os.path.join(dataset_path, r'C:/Users/musta/OneDrive/Рабочий стол/lab3_part1/runs/detect/train9/weights/best.onnx'))
...
if __name__ == "__main__":
    ...
    if os.path.exists(os.path.join(dataset_path, r'C:/Users/musta/OneDrive/Рабочий стол/lab3_part1/runs/detect/train9/weights/best.onnx')):
        print("Файл .onnx найден.")
    else:
        print("Файл .onnx не найден.")

    image_path = r"C:/Users/musta/OneDrive/Рабочий стол/lab3_part1/dataset/test/images/1.jpg"
